...
public class ContactsView extends AbstractView {
    ...
    /**
     * @param contactStore a manager for active XMPP connections
     */
    public ContactsView(final XMPPConnectionManager contactStore) {
        ...
        /*
         * JXButton clearFindButton = new JXButton("X"); clearFindButton.addActionListener(new ActionListener() { public
         * void actionPerformed(ActionEvent e) { findField.setText(""); } }); findBox.add(clearFindButton);
         */
        ...
        changeTypeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                changeTypeMenu.show(changeTypeButton, changeTypeButton.getWidth() - changeTypeMenu.getWidth(),
                        changeTypeButton.getHeight());
            }
        });
                    ...
                    if (contact.getAvatar() != null) {
                        ...
                        JToolTip toolTip = new JToolTip() {
                            ...
                            public void paint(Graphics g) {
                                ...
                                g2d.drawImage(avatar.getImage(), insets.left, insets.top, width
                                        - (insets.left + insets.right), height - (insets.top + insets.bottom), null);
                            }
                        };
        ...
        if (Type.CONTACTS.equals(type)) {
            ...
            model.addListDataListener(new ListDataListener() {
                ...
                public void contentsChanged(ListDataEvent e) {
                    if (e.getIndex0() < contactList.getSelectedIndex()
                            && e.getIndex1() > contactList.getSelectedIndex()) {
                        contactList.clearSelection();
                    }
                }
